...
if (!$id_grade||!$id_disciplina||!$id_professor) {
...
$sql = "
  UPDATE grade_aulas
     SET id_disciplina=?, id_professor=?, sala=?, cor_evento=?
   WHERE id_grade=?
";
$stmt = $mysqli->prepare($sql);
$stmt->bind_param('iissi', $id_disciplina, $id_professor, $sala, $cor_evento, $id_grade);
if (!$stmt->execute()) {
